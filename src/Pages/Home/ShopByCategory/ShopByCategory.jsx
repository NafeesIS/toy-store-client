                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {superheroRobots.map(robot => (
                                <div key={robot._id} className="card w-96 bg-base-100 shadow-xl">
                                    <h2 className='text-xl text-center text-pink-800 my-8 font-bold font-serif italic mb-8'>Sub-category: {robot.sub_category}</h2>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {transformerRobots.map(transformer => (
                                <div key={transformer._id} className="card w-96 bg-base-100 shadow-xl">
                                    <h2 className='text-xl text-center text-pink-800 my-8 font-bold font-serif italic mb-8'>Sub-category: {transformer.sub_category}</h2>
                                    <figure className="px-10 pt-10">
                                    ...
                                    <div className="card-body items-center text-center">
                                        ...
                                        <div className="card-actions">
                                            <Link to={`/transformertoydetails/${transformer._id}`}>  <button className="btn btn-primary bg-pink-800">View Details</button></Link>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {constructorRobots.map(constructor => (
                                <div key={constructor._id} className="card w-96 bg-base-100 shadow-xl">
                                    <h2 className='text-xl text-center text-pink-800 my-8 font-bold font-serif italic mb-8'>Sub-category: {constructor.sub_category}</h2>
                                    <figure className="px-10 pt-10">
                                    ...
                                    <div className="card-body items-center text-center">
                                        ...
                                        <div className="card-actions">
                                            <Link to={`/constructortoydetails/${constructor._id}`}>  <button className="btn btn-primary bg-pink-800">View Details</button></Link>
                                        </div>
                                    </div>
                                </div>
                            ))}
